#!/usr/bin/wish
# ************************************************************************
# FILE: graph_exercise_4.4_20.tcl
#
# DESCRIPTION:
#    Tcl script to graph the equation from Exercise 4.4-20
#*************************************************************************
...
for { set x $min_x } { $x <= $max_x } { set x [expr $x + 0.001] } {
   ...
   set y [expr ( (1/20) * $x5 - (0.75) * $x4 + (23/6) * $x3 - (7.5) * $x2 + 4 ) ]
