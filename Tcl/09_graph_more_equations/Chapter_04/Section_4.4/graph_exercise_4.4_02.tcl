#!/usr/bin/wish
# ************************************************************************
# FILE: graph_exercise_4.4_02.tcl
#
# DESCRIPTION:
#    Tcl script to graph the equation from Exercise 4.4-02
#*************************************************************************
...
proc Draw_Y_Grid_Marks { } {
   ...
   for { set y $min_y } { $y <= $max_y } { set y [expr $y + 20] } {
