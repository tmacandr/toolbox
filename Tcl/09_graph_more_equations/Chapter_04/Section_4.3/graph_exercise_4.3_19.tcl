#!/usr/bin/wish
# ************************************************************************
# FILE: graph_exercise_4.3_19.tcl
#
# DESCRIPTION:
...
for { set x $min_x } { $x <= $max_x } { set x [expr $x + 0.001] } {
   ...
   set firstx [expr ($firstx * $firstx * $firstx)]

   set secondx [expr ($x + 1)]

   set secondx [expr ($secondx * $secondx * $secondx * $secondx)]

   set y [ expr ( $firstx * $secondx ) ]
