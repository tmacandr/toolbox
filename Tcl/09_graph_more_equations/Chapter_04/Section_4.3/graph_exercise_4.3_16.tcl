#!/usr/bin/wish
# ************************************************************************
# FILE: graph_exercise_4.3_16.tcl
#
# DESCRIPTION:
...
set max_y [expr 1700000.0]
set max_y [expr 900000.0]
set max_y [expr 450000.0]
...
proc Draw_Y_Grid_Marks { } {
   ...
   for { set y $min_y } { $y <= $max_y } { set y [expr $y + 50000] } {
...
for { set x $min_x } { $x <= $max_x } { set x [expr $x + 0.001] } {
   ...
   set tempx [expr ($x2 - 10 * $x)]

   set y [expr ($tempx * $tempx * $tempx *$tempx)]
