...
for { set x $min_x } { $x <= $max_x } { set x [expr $x + 0.01] } {
   ...
   set red_sine [.the_canvas create rectangle $x1 $y1 $x1 $y1 -width 0 -fill red]
   ...
   set green_cosine [.the_canvas create rectangle $x1 $y1 $x1 $y1 -width 0 -fill magenta]
} 
